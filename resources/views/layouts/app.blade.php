...
<head>
    ...
    <title>SamPC - Contest tizimi</title>
    ...
    <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
        ...
        <footer class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
            <ul class="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
                <li><a href="{{ route('tasks') }}" class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6 dark:text-gray-400">Masalalar</a></li>
            </ul>
        ...
        <p class="my-10 text-sm text-center text-gray-500">
            &copy; 2018-{{date('Y')}} <a href="http://sampc.uz/" class="hover:underline" target="_blank">sampc.uz</a>. All rights reserved.
        </p>
